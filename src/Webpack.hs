...
-- This type family is a type function (whose result is of kind Constraint, i.e.,
-- it has has a single inhabitant type Unit). It allows to detect if two types
-- <e> and <es>, whose kinds are structurally compatible, share the at least one
-- type.
